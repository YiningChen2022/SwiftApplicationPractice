...
class PayWallViewController: UITabBarController {
    ...
    private let termsView: UITextView = {
        ...
        textView.text = "This is an auto-renewable subscription. It will be charged to your iTunes account before each pay period. You can cancel anytime by going into your Settings>subscriptions. Restore purchases if previous subscripted"
        return textView
    }()
    
    override func viewDidLoad() {
        super.viewDidLoad()
        title = "NEU Plus Premium"
