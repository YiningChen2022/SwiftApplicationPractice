...
import Foundation
import UIKit
class SearchByTrade :UIView, UITableViewDelegate, UITableViewDataSource {
    ...
    private let nameField: UITextField = {
        ...
        private let SearchButton: UIButton = {
            let button = UIButton()
            button.backgroundColor = .systemBlue
            button.setTitle("Search lastest trade price Above", for: .normal )
            button.setTitleColor(.white, for: .normal)
