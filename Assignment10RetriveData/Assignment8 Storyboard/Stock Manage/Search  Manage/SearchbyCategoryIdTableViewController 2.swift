...
class SearchbyCategoryIdTableViewController: UITableViewController {
    ...
    override func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath)->UITableViewCell{
         ...
         let str = AppDelegate.GlobalVariable.stocklist.testStocklist.searchByCategory(categoryid: AppDelegate.GlobalVariable.selectedCategorySearch)[indexPath.row]
