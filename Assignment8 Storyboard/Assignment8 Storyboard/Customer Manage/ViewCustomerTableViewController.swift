...
class ViewCustomerTableViewController: UITableViewController, UISearchResultsUpdating,UISearchBarDelegate {
    ...
    override func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath)->UITableViewCell{
        ...
        cell.detailTextLabel?.text = components[3]
        //cell.detailTextLabel!.text = components[3]
    ...
    @IBAction func tapUpdate(_ sender: UIBarButtonItem) {
        let selected = AppDelegate.GlobalVariable.customerlist.testcustomerlist.toString()[tableView.indexPathForSelectedRow!.row]
